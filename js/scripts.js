    ...
    fetch('../php/functions.php', {
        ...
        .then(alumno => {
            ...
            async function Formato_noadeudo() {
                ...
                var vnoControl = alumno['noControl'];
                var vnombre = alumno['nombre'];
                var vapellidoPat = alumno['apellidoPat'];
                var vapellidoMat = alumno['apellidoMat'];
                var vsemestre = alumno['semestre'];
                var vcarrera = alumno['carrera'];
                var vlaboratorio = "Industrial XD";
